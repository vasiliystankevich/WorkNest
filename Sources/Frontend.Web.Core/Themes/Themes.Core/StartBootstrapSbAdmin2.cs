...
namespace Themes.Core
{
    public class StartBootstrapSbAdmin2:ThemeBaseBundleConfig
    {
        ...
        public override void RegisterBundles()
        {
            RegisterCss(new []
            {
                ...
                $"~/Themes/{ModuleName}/{ThemeName}/vendor/font-awesome/css/font-awesome.min.css",
    ...
    public class ResponsibleTables : ThemeBaseBundleConfig
    {
        public ResponsibleTables() : base("responsible-tables")
        {
        }
        ...
        public override void RegisterBundles()
        {
            RegisterCss(new[]
            {
                $"~/Themes/{ModuleName}/startbootstrap-sb-admin-2/vendor/datatables-plugins/dataTables.bootstrap.css",
                $"~/Themes/{ModuleName}/startbootstrap-sb-admin-2/vendor/datatables-responsive/dataTables.responsive.css",
            });
            RegisterJs(new[]
            {
                $"~/Themes/{ModuleName}/startbootstrap-sb-admin-2/vendor/datatables/js/jquery.dataTables.min.js",
                $"~/Themes/{ModuleName}/startbootstrap-sb-admin-2/vendor/datatables-plugins/dataTables.bootstrap.min.js",
                $"~/Themes/{ModuleName}/startbootstrap-sb-admin-2/vendor/datatables-responsive/dataTables.responsive.js"
            });
        }
    }
}
